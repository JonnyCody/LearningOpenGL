...
int main()
{
    ...
    // ------------------------------------
    // shader
    Shader lightingShader("E:/ComputerGraphics/Code/LearnOpenGL-master/src/part2/2.1colors.vs", 
        "E:/ComputerGraphics/Code/LearnOpenGL-master/src/part2/2.1colors.fs");
