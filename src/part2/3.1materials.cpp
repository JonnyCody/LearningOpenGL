...
int main()
{
    ...
    // ------------------------------------
    // shader
    Shader lightingShader("E:/ComputerGraphics/Code/LearnOpenGL-master/src/part2/3.1materials.vs", 
        "E:/ComputerGraphics/Code/LearnOpenGL-master/src/part2/3.1materials.fs");
