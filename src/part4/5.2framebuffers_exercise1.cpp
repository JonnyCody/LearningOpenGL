...
int main()
{
    ...
    // -------------------------
    Shader shader(FileSystem::getPath("src/part4/5.2frame_buffers.vs").c_str(),
        FileSystem::getPath("src/part4/5.2frame_buffers.fs").c_str());
    Shader screenShader(FileSystem::getPath("src/part4/5.2frame_buffers_screen.vs").c_str(),
        FileSystem::getPath("src/part4/5.2frame_buffers_screen.fs").c_str());
